...
target_table = "bronze.bronze_sch.bronze_tarrif_metrics"
...
PROCESS_NAME = "Ingest_tarrif_metrics"
FILE_NAME = "tariff_metrics_stream_v2.parquet"
TARGET_TABLE = "bronze.bronze_sch.bronze_tariff_metrics"
...
try:
    ...
    inserted_rows = tarrif_bronze.count()
